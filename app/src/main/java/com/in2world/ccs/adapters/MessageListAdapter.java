...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    private List<ChatActivity.TestMessage> mMessageList;

    private int mPosition =0;
    public MessageListAdapter(Context context, List<ChatActivity.TestMessage> messageList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ChatActivity.TestMessage message = mMessageList.get(position);
    ...
    @Override
     public int getItemViewType(int position) {
        ...
        ChatActivity.TestMessage message = mMessageList.get(position);
         if (message.getId() == VIEW_TYPE_MESSAGE_SENT) {
